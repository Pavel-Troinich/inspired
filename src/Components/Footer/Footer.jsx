        ...
        <div className={style.container}>
          <div className={style.category}>
            ...
            <ul className={style.categoryList}>
              {list.map(item => (
                <li className={style.categoryItem} key={item.link}>
                  ...
                  <ul className={style.categorySublist}>
                    {item.categories.map(category => (
                      <li key={category.link}>
                        <NavLink className={style.list} to={`${item.link}/${category.link}`}>
                          {category.title}
                        </NavLink>
                      </li>
                    ))}
          ...
          <div className={style.development}>
            <ul className={style.developmentList}>
              <li className={style.developmentItem}>
                Designer
                <a href='tg://resolve?domain=Quper' className={style.link}>Anastasia Ilina</a>
              </li>
              <li className={style.developmentItem}>
                Developer:
                <a href='tg://resolve?domain=vel_3o' className={style.link}>Pavel Troinich</a>
              </li>
            </ul>
          </div>
        </div>
